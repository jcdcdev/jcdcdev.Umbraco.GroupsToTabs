        ...
        foreach (var contentType in contentTypes)
        {
            ...
            switch (contentType)
            {
                case IContentType content:
                    await contentTypeService.SaveAsync(content, global::Umbraco.Cms.Core.Constants.Security.SuperUserKey);
                    break;
                case IMediaType media:
                    await mediaTypeService.SaveAsync(media, global::Umbraco.Cms.Core.Constants.Security.SuperUserKey);
                    break;
                case IMemberType member:
                    await memberTypeService.SaveAsync(member, global::Umbraco.Cms.Core.Constants.Security.SuperUserKey);
                    break;
            }
        }
